# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-10-19 07:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mysite', '0002_auto_20191018_1805'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mysite.Campuses', verbose_name='校区')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='mysite.ClassList', verbose_name='已报班级')),
            ],
            options={
                'verbose_name': '客户信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mysite.Department')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='mysite.UserInfo', verbose_name='销售'),
        ),
        migrations.AddField(
            model_name='customer',
            name='introduce_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mysite.Customer', verbose_name='转介绍自学员'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='mysite.UserInfo', verbose_name='老师'),
        ),
